...
export const CountSelection = ({ initialCount, next }: Props) => {
  ...
  const [customAmount, setCustomAmount] = useState("" + (options.includes(pounds) ? "" : pounds))
  ...
  return (
    <VStack spacing={4} align='stretch'>
      ...
      <Button width='full' colorScheme='orange' size='lg' borderRadius='full' onClick={nextStep}>
        Next
      </Button>
    </VStack>
  )
